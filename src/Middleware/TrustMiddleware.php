...
class TrustMiddleware
{
	...
	{
		[$team, $requireAll, $guard] = $this->assignRealValuesTo($team, $options);
	...
	{
		$handling = Config::get('trust.middleware.handling');
		$handler = Config::get("trust.middleware.handlers.{$handling}");
